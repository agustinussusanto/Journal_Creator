...
import { BookOpen, Search, LogOut, User, FileText, Copy, AlertCircle } from 'lucide-react';
import { Button } from '../components/ui/Button';

export default function JournalMaker() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-sans pb-20">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-3xl font-bold text-slate-900 mb-6">Journal Maker</h1>
          <p className="text-slate-600 mb-8 leading-relaxed">
            Selamat datang di Journal Maker. Halaman ini dirancang untuk membantu Anda menyusun draf jurnal akademik yang lengkap.
          </p>
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-6 mb-8">
            ...
            <ul className="text-sm text-indigo-800 space-y-2 list-disc list-inside">
              ...
              <li>Pastikan setiap bagian jurnal disusun secara sistematis sesuai standar akademik.</li>
            </ul>
            
            <div className="mt-6 flex justify-center">
              <a 
                href="https://academic-ai-writer-83de4624.base44.app" 
                target="_blank" 
